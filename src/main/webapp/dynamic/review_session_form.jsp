...
<html>
	<head>
		<title>Review Session Form</title>
		
	    <style type="text/css">
   		<%@include file="../css/review_session.css" %></style>
		...
		<tr>
			<form action="review_session_form.jsp" method="post">
				<input type="hidden" value="insert" name="action"> 
					<td> <input type="text" value="" name="Class Title"></td> 
					...
					<td><input type="text" value="" name="Section ID"></td>
					<td><input type="text" value="" name="Room"></td>
					<td><input type="date" value="" name="Date"></td>
					<td><input type="time" value="" name="Time"></td>
					<td><input type="text" value="" name="Mandatory"></td>
					<td><input type="text" value="" name="Meeting Type"></td>
